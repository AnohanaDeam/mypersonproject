...
<body>
  	...
  	<div class="mdui-container doc-container">
  		<h1 class="doc-title mdui-text-color-theme mdui-text-color-indigo">待审核业务</h1>
          ...
          <table class="mdui-table mdui-table-hoverable">
            ...
            <tbody>
            <c:forEach items= "${business2}" var="b2">
           <tr>
             <td class="mdui-text-center">${b2.applicant_name}</td>
             <td class="mdui-text-center">${b2.id_number}</td>
             <td class="mdui-text-center">${b2.phone}</td>
             <td class="mdui-text-center">${b2.service_name}</td>
             <td class="mdui-text-center"><a href="Admin/sav1?xx=${b2.business_number}">业务审核</a></td>
           </tr>
             </c:forEach>
            </tbody>
          </table>
